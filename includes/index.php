...
<ul class="nav-menu">
    ...
    <li><a href="login/signup.php" class="join-btn">JOIN</a></li>
</ul>
    ...
    <?php if ($is_logged_in): ?>
        ...
        <?php if ($unread_count > 0): ?>
            ...
            if(alert) alert.style.display = "none";
                                ...
                                <section style="width: 100%; height: 600px; overflow: hidden;">
    <img src="images/main-banner.png" alt="Main Banner" style="width: 100%; height: 100%; object-fit: cover;">
</section>
                                <!-- 프로모션 섹션 -->
                                ...
                                <img src="images/sunil-logo.svg" alt="SUNIL SHIPPING" style="width: 250px; margin-bottom: 40px;">
                                <h2 class="footer-title">A trusted logistics partner<br/> connecting the world.</h2>
                                ...
                                <p style="font-weight: 400; font-size: 15px; margin-bottom: 10px;">사업자등록번호 202-81-43701</p>
                                <p style="font-weight: 400; font-size: 15px; margin-bottom: 10px;">대표이사 송병찬 </p>
                                <p style="font-weight: 400; font-size: 15px; ">주소 <br /> 인천광역시 연수구 능허대로 227-10 1Fㆍ3F</p>
