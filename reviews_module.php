    ...
    <p>What our customers say about SUNIL SHIPPING</p>
            ...
            <?php if (empty($reviews)): ?>
                ...
                <div style="text-align: center; padding: 4rem 2rem; background: white; border-radius: 12px;">
                    <i class="fas fa-comments" style="font-size: 20px; color: #d1d5db; margin-bottom: 1rem;"></i>
...
<div class="reviews-grid" id="reviewsGrid">
      <?php 
    $reviewsTriple = array_merge($reviews, $reviews, $reviews);
    foreach ($reviewsTriple as $review): 
?>
...
<div class="review-footer">
    ...
    <div class="rating-summary">
        <div class="stars-display">
            <?php for ($i = 1; $i <= 5; $i++): ?>
                <img src="images/<?= $i <= $review['rating'] ? 'star.svg' : 'star-empty.svg' ?>" 
       alt="star" 
