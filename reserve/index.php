...
function renderDefaultCard($product, $availability, $is_logged_in) {
    ...
    // 남은시간 계산 - valid_until 컬럼 사용
    $valid_until = $product['valid_until'] ?? null;
    $remaining_timestamp = 0;
    if ($valid_until) {
        $valid_time = strtotime($valid_until);
        $remaining_timestamp = max(0, $valid_time - time());
    }
        ...
        <div class="card-content">
            ...
            <div class="card-info-list">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value"><?= htmlspecialchars($product['transit_time']) ?> days</span>
                </div>
                <div class="info-row">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value countdown-timer" style="color: #dc2626;" data-remaining="<?= $remaining_timestamp ?>"><?= $remaining_timestamp > 0 ? 'Calculating...' : 'Closed' ?></span>
                </div>
            </div>
    ...
    <div class="product-card">
        ...
        <div class="route-section">
            ...
            <div class="transit-info">
                <div class="transit-label">Transit Time</div>
                <div class="transit-days"><?= htmlspecialchars($product['transit_time']) ?> days</div>
            </div>
        ...
        <div class="price-section">
            <?php if ($is_logged_in): ?>
                ...
                <div class="price-display">
                    <div class="price-label"><?= $grade_label ?> Price</div>
        ...
        <div class="ship-body">
            ...
            <div class="ship-details">
                <div class="detail-item">
                    ...
                    <div class="detail-value"><?= htmlspecialchars($product['transit_time']) ?>D</div>
                </div>
                <div class="detail-item">
...
<body>
    ...
    <script>
        ...
        function updateTimerDisplay(element, seconds) {
            ...
            if (days > 0) {
                element.textContent = `${days}일 ${pad(hours)}:${pad(minutes)}:${pad(secs)}`;
            } else {
                element.textContent = `${pad(hours)}:${pad(minutes)}:${pad(secs)}`;
            }
        }
    </script>
</body>
