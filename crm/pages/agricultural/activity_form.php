...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $csrfToken) {
        ...
        $data = [
            'customer_id' => $_POST['customer_id'] ?? $customerId,
        ...
        if (empty($data['customer_id'])) {
            ...
            try {
                // 활동 테이블 생성 (없으면)
                $pdo->exec("CREATE TABLE IF NOT EXISTS " . CRM_AGRI_ACTIVITIES_TABLE . " (
                ...
                header('Location: customer_detail.php?id=' . $data['customer_id']);
                exit;
            } catch (Exception $e) {
...
.section-title { font-size: 16px; font-weight: 600; color: #198754; margin-bottom: 16px; padding-bottom: 8px; border-bottom: 1px solid #e9ecef; }
...
<div class="container">
    ...
    <div class="page-header">
        <a href="<?= $customerId ? 'customer_detail.php?id=' . $customerId : 'customers.php' ?>" class="btn-back">← 뒤로</a>
    ...
    <form method="POST">
        ...
        <div class="card">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input" value="<?= h($customer['company_name'] ?? '') ?>" readonly placeholder="거래처명">
            </div>
        ...
        <!-- 제안 전용 폼 -->
        <div class="card hidden" id="proposalForm">
            <div class="section-title">제안 상세</div>
            <div class="form-group">
        ...
        <!-- 거래 전용 폼 -->
        <div class="card hidden" id="transactionForm">
            <div class="section-title">거래 상세</div>
            <div class="form-group">
        ...
        <div class="button-group">
            <a href="<?= $customerId ? 'customer_detail.php?id=' . $customerId : 'customers.php' ?>" class="btn btn-cancel">취소</a>
